...
class VOCEvaluator:
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(progress_bar(self.dataloader)): #self.dataloader contains eval_loader 
            with torch.no_grad():
            ...
            data_list.update(self.convert_to_voc_format(outputs, info_imgs, ids)) #datalist = predictions(bboxes, cls, scores) on val dataset 
